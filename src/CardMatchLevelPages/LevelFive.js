...
export default class LevelFiveLevelFive extends Component {
    ...
    state = {
        ...
        imageType:[
            ...
            require("../../image/six.png"),
            require("../../image/seven.png"),
            require("../../image/eight.png"),
            require("../../image/nine.png"),
            ...
            require("../../image/one1.png"),
            require("../../image/two2.png"),
            require("../../image/three2.png"),
            require("../../image/four2.png"),
            require("../../image/five2.png")
        ],
        randomA: [],
        active1:"",
        active2:"",
                ...
                <View style={styles.container} >
                    ...
                    <FlatList 
                        scrollEnabled={false}
                         ...
                         contentContainerStyle = {{height:'60%', marginTop:'35%', width:'100%'}}
                         ...
                         renderItem = {({item, key, index})=> 
                            <>
                            {item.image !== "" &&
                                <TouchableOpacity style={{width:75, height:110}} onPress={()=>this.check(item) }  >
                                    {item.active !== true ? 
